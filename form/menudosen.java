...
public class menudosen extends javax.swing.JDialog {
   ...
   public menudosen(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM MENU DOSEN");
...
public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
        public void run() {
            ...
            menudosen  dialog = new menudosen(new javax.swing.JFrame(), true);
